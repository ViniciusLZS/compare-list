...
export default function Message() {
  const phrases = [
    ...
    'Economize dinheiro revisando suas contas mensais e eliminando assinaturas ou serviços desnecessários.',
    'Mantenha uma planilha de gastos para ter uma visão clara do seu dinheiro e onde pode economizar.',
    ...
    'Seja organizado e economize dinheiro planejando com antecedência suas férias e viagens, reservando com antecedência e evitando despesas desnecessárias.',
  ];
